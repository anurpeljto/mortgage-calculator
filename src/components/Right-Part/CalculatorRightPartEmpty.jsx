...
const CalculatorRightPartEmpty = ({visible}) => {
  return (
    <div className={`flex flex-col p-10 sm:mb-0 mb-10 gap-2 flex-1 w-full h-full items-center justify-center bg-slate_900 sm:rounded-tr-3xl rounded-br-3xl ${visible ? `block`: `hidden`}`}>
      <img src={empty} alt="" />
